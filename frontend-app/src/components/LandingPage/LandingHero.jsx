    ...
    <div className='min-h-screen flex flex-col relative z-10'>
      ...
      <nav className='px-6 lg:px-8 py-6 flex justify-between items-center max-w-7xl mx-auto w-full relative z-20'>
        ...
        <div className='flex items-center gap-3 sm:gap-5'>
          ...
          <button
            onClick={openLogin}
            className='bg-black hover:bg-neutral-800 dark:bg-white dark:hover:bg-neutral-200 text-white dark:text-black font-bold py-2 px-5 rounded-full transition-all text-sm items-center gap-2 group shadow-lg hidden sm:flex'>
            {tMsg('Log in', 'Masuk')}
            <Icon
              name='arrow-right'
        ...
        <div className='grid lg:grid-cols-2 gap-12 lg:gap-8 items-center'>
          <div className='max-w-2xl text-left'>
            <div className='inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-100 dark:bg-neutral-900 text-black dark:text-white font-bold text-xs mb-6 border border-neutral-200 dark:border-neutral-800'>
              ...
              {tMsg(
                'For INNOCEAN Indonesia employees',
                'Untuk karyawan INNOCEAN Indonesia'
              )}
            </div>
            <h1 className='text-4xl sm:text-5xl lg:text-6xl font-black mb-6 leading-[1.1] text-slate-900 dark:text-white'>
              {tMsg(
          ...
          <div className='relative hidden lg:block lg:h-full lg:w-full perspective-[1000px]'>
                ...
                <div className='flex-1 p-5 bg-white dark:bg-[#0e1116]'>
                  ...
                  <div className='grid grid-cols-3 gap-3 h-[300px]'>
                    {[
                      ...
                      <div
                        key={col.title}
                        className='bg-slate-50 dark:bg-slate-900/60 rounded-xl p-2.5 flex flex-col gap-2'>
