          ...
          <div className='flex gap-4 sm:gap-6 h-full p-4 sm:p-6 bg-slate-50/50 dark:bg-slate-900/50 items-center justify-center'>
            ...
            <div className='flex-1 flex flex-col gap-3 sm:gap-4'>
              {[
                ...
                <div key={i}>
                  <div className='text-[9px] sm:text-[10px] font-bold text-slate-500 mb-1'>
                    {stat.label}
                  </div>
  ...
  return (
    <>
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16 reveal-on-scroll'>
            ...
            <p className='text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto text-lg leading-relaxed'>
              Switch seamlessly between multiple views to manage your work
              exactly how you want. No reloads required.
            </p>
          </div>
              ...
              {features.map((feature) => (
                <button
                  ...
                  <h3
                    ...
                    <Icon name={feature.icon} className='w-5 h-5 shrink-0' />{' '}
                    {feature.title}
                  </h3>
                  <p
      ...
      <section
        ...
        <div className='max-w-6xl mx-auto px-6'>
          <div className='text-center mb-16 reveal-on-scroll'>
            ...
            <p className='text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto text-lg leading-relaxed'>
              More than just a to-do list. Built on robust standards to securely
              automate your team's daily operations.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            <div
              ...
              <p className='text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed'>
                Industry-standard security with stateless JWT, Bcrypt hashing,
                and strict Role-Based Access Control. Automated CI/CD pipelines
            ...
            <div
              ...
              <p className='text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed'>
                Automated project scheduling that intelligently bypasses
                weekends and national holidays. A dynamic hybrid queue system
                tracks precise workload bottlenecks.
              </p>
            </div>
            <div
              className='bg-white dark:bg-[#111827] p-8 border border-slate-200 dark:border-slate-800 rounded-3xl hover:-translate-y-2 transition-transform shadow-sm hover:shadow-xl reveal-on-scroll relative overflow-hidden group'
              ...
              <p className='text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed'>
                Dual-engine AI architecture (Google Gemini & GPT-OSS 120B) for
                proactive task drafting, live meeting extractions, and
            ...
            <div
              ...
              <p className='text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed'>
                Secure team workspaces with real-time chat, Direct Messages,
                1-click Google Meets, and safe read-only guest previews for
                external sharing.
              </p>
            </div>
            <div
              ...
              <p className='text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed'>
                Instantly generate executive reports, monitor project health,
                and balance team workloads visually using Estimated Time
                Consumption (ETC) metrics.
              </p>
            </div>
            <div
              className='bg-white dark:bg-[#111827] p-8 border border-slate-200 dark:border-slate-800 rounded-3xl hover:-translate-y-2 transition-transform shadow-sm hover:shadow-xl reveal-on-scroll relative overflow-hidden group'
              ...
              <p className='text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed'>
                Built on React 18, Vite, and FastAPI. Features an optimistic UI
                for zero-latency interactions and a self-cleaning database for
                perpetual speed.
              </p>
            </div>
          </div>
      ...
      <section
        ...
        <div className='absolute inset-0 -z-10 h-full w-full bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] dark:bg-[radial-gradient(#1f2937_1px,transparent_1px)]'>
          ...
          <div
            className='absolute top-0 right-0 -z-10 transform-gpu blur-3xl opacity-30'
            aria-hidden='true'>
            <div
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center mb-16 reveal-on-scroll'>
            ...
            <p className='text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto text-lg leading-relaxed'>
              Stop adapting to generic tools. Experience a platform built
              specifically for your team's unique workflow.
            </p>
          </div>

          <div
            className='overflow-auto custom-scrollbar reveal-on-scroll max-h-96 border border-neutral-200 rounded-3xl shadow-inner bg-white relative'
            style={{ animationDelay: '200ms' }}>
            <table className='w-full text-left border-separate border-spacing-0 min-w-96'>
              <thead>
                <tr>
                  ...
                  <th className='sticky top-0 z-30 bg-indigo-50 p-4 md:p-6 text-[10px] sm:text-xs font-black uppercase tracking-widest text-indigo-700 border-b-2 border-indigo-200 w-1/4 text-center rounded-t-3xl border-x border-t-4 border-t-indigo-500 border-x-indigo-100 shadow-[0_-15px_30px_rgba(99,102,241,0.15)]'>
                    INNOCEAN Tracker
                  </th>
              ...
              <tbody className='text-xs sm:text-sm font-medium'>
                ...
                <tr>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 font-black uppercase tracking-widest text-indigo-600 text-xs sm:text-sm border-b-2 border-neutral-200'>
                    <Icon name='rocket' className='w-4 h-4 inline-block mr-1' />{' '}
                    Deployment & Cost
                  </td>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      No per-seat pricing. Fully open-source and deployable on
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Employees login via Google SSO and instantly access their
                      dashboard without manual HR provisioning.
                    </div>
                  </td>
                  ...
                  <td className='p-4 md:p-6 border-b border-neutral-100 text-center text-xl sm:text-2xl opacity-30 grayscale'>
                    <Icon
                      name='x'
                      className='w-5 h-5 inline-block text-red-400'
                    />
                    <span className='block text-[8px] font-bold text-neutral-500 uppercase tracking-widest mt-1'>
                      MANUAL INVITES
                    </span>
                  ...
                  <td className='p-4 md:p-6 border-b border-neutral-100 text-center text-xl sm:text-2xl opacity-70'>
                    <Icon
                      name='minus'
                      className='w-5 h-5 inline-block text-amber-500'
                    />
                    <span className='block text-[8px] font-bold text-neutral-500 uppercase tracking-widest mt-1'>
                      ENTERPRISE ADD-ON
                    </span>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    <div className='text-slate-800 font-bold uppercase tracking-wider mb-1'>
                      Project Board Limits
                    </div>
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Create as many isolated project workspaces as your team
                      needs without paywalls.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center font-black text-emerald-600 uppercase tracking-widest text-[10px] sm:text-xs'>
                    UNLIMITED
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Runs immediately on modern cloud providers (Vercel/Render)
                  ...
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                      name='check-circle'
                      className='w-5 h-5 inline-block text-emerald-500 mx-auto'
                    />
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 text-center text-xl sm:text-2xl'>
                    <Icon
                      name='check-circle'
                      className='w-5 h-5 inline-block text-emerald-500 mx-auto'
                    />
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      The interface updates instantly before the server
                      responds, ensuring a lag-free experience.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                  ...
                  <td className='p-4 md:p-6 border-b border-neutral-100 text-center text-xl sm:text-2xl opacity-30 grayscale'>
                    <Icon
                      name='x'
                      className='w-5 h-5 inline-block text-red-400 mx-auto'
                    />
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 text-center text-xl sm:text-2xl opacity-70'>
                    <Icon
                ...
                <tr>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 font-black uppercase tracking-widest text-indigo-600 text-xs sm:text-sm border-b-2 border-neutral-200'>
                    <Icon name='bot' className='w-4 h-4 inline-block mr-1' /> AI
                    & Smart Assistant
                  </td>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 border-b-2 border-neutral-200 bg-neutral-50'></td>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 border-b-2 border-neutral-200'></td>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Powered by GPT-OSS 120B and Google Gemini with automatic
                      failover to prevent downtime.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Type naturally and let AI extract details to automatically
                      fill out task creation forms.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      AI automatically distinguishes between task assignees
                      (workers) and requesters from chat context.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      AI drafts intelligent, contextual follow-up messages to
                      remind assignees about their tasks.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100 text-slate-800 font-bold uppercase tracking-wider'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Get highly relevant answers from an AI that reads your
                      task brief and comment history.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Paste raw meeting notes and let AI bulk-create actionable
                      tasks and assign them automatically.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Ask AI to generate conceptual workflows or architectures
                      rendered in interactive ASCII blocks.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Real-time meeting scratchpad with AI generating contextual
                      follow-up questions as you type.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    <div className='text-slate-800 font-bold uppercase tracking-wider mb-1'>
                      Smart Kanban Archive
                    </div>
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Terminal columns automatically hide old completed tasks to
                      keep your board fast and clutter-free.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Workloads are calculated using Estimated Time Consumption
                      (Hours) instead of inaccurate task counts.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      AI reads your dashboard and generates natural language
                      executive summaries of your team's health.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Drag and drop tasks vertically between team members on the
                      Gantt chart to instantly reassign work.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Live charts tracking project velocity, completion rates,
                      and individual workload distribution.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                  ...
                  <td className='p-4 md:p-6 border-b border-neutral-100 text-center text-xl sm:text-2xl opacity-70'>
                    <Icon
                      name='minus'
                      className='w-5 h-5 inline-block text-amber-500 mx-auto'
                    />
                    <span className='block text-[8px] font-bold text-neutral-500 uppercase tracking-widest mt-1'>
                      MANUAL PIVOT
                    </span>
                ...
                <tr>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 font-black uppercase tracking-widest text-indigo-600 text-xs sm:text-sm border-b-2 border-neutral-200'>
                    <Icon name='clock' className='w-4 h-4 inline-block mr-1' />{' '}
                    Time & Deadlines
                  </td>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 border-b-2 border-neutral-200 bg-neutral-50'></td>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 border-b-2 border-neutral-200'></td>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Calculates health scores based on completion rates, WIP
                      limits, and overdue task penalties.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    🟢
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Automatically bypasses weekends and national red dates
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Drag the edges of a task directly on the Gantt or Calendar
                      view to adjust its duration.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Pushes deadlines forward automatically if they land on a
                      weekend or a registered public holiday.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    🟢
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Set tasks to repeat daily, weekly, or monthly. A new cycle
                      spawns automatically when completed.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Log personal vacations. The timeline visually blocks out
                      days when team members are away.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Create personal to-do lists locked exclusively to you.
                      Team chats and invites are disabled.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Dedicated channels for every project, specific task
                      threads, and 1-on-1 direct messages.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Monitor all your assigned tasks across multiple workspaces
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Break down main tasks into checklists and assign specific
                      items to different team members.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Tag colleagues using @username to instantly send them an
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Instantly generate project-specific Google Meet rooms
                      directly from the task chat.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Share specific tasks via secure URLs that teleport
                      authenticated users directly to the card.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 font-black uppercase tracking-widest text-indigo-600 text-xs sm:text-sm border-b-2 border-neutral-200'>
                    <Icon name='shield' className='w-4 h-4 inline-block mr-1' />{' '}
                    Platform & Security
                  </td>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 border-b-2 border-neutral-200 bg-neutral-50'></td>
                  <td className='px-4 py-6 md:px-6 md:pt-10 md:pb-4 border-b-2 border-neutral-200'></td>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Strictly allows logins only from whitelisted corporate
                      domains.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      CI/CD pipelines automatically test against vulnerabilities
                      before deployment.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Silently tracks and records every status change, edit, and
                      reassignment for complete transparency.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Strict permission levels for Super Admins, Project Owners,
                      and regular Team Members.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Automatically deletes 6-month-old completed tasks and
                      1-year-old chats to prevent server bloat.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                    <Icon
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Queue multiple tasks in a local cart and dispatch them to
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Google-like search engine that matches keywords regardless
                      of their sequence.
                    </div>
                  </td>
                  <td className='p-4 md:p-6 border-b border-neutral-100 bg-neutral-50 text-center text-xl sm:text-2xl'>
                ...
                <tr className='hover:bg-neutral-50 transition-colors'>
                  <td className='p-4 md:p-6 border-b border-neutral-100'>
                    ...
                    <div className='text-[10px] sm:text-xs text-neutral-500 font-medium leading-relaxed normal-case tracking-normal'>
                      Your data stays in your database. No AI training retention
