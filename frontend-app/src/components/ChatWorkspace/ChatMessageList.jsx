...
export default function ChatMessageList({
  ...
  return (
    <>
      ...
      {/* Floating Mentions Jumper & Scroll-to-bottom (Fixed relative to parent view container) */}
      <div className="absolute bottom-4 right-6 flex flex-col gap-2 z-40 pointer-events-none [&>button]:pointer-events-auto">
        {latestMentionId && (
          <button
            type="button"
            onClick={() => {
