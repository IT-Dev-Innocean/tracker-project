...
function InnoceanLogo() {
  return (
    <Link to="/" className="flex items-center gap-3">
      <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-black text-sm font-black text-white dark:bg-white dark:text-black">
        IN
      </div>
      <div className="leading-none">
        <span className="block text-base font-black tracking-[0.16em] text-slate-900 dark:text-white">
          INNOCEAN
        </span>
        <span className="mt-1 block text-[10px] font-semibold tracking-[0.28em] text-slate-500 dark:text-slate-400">
          TRACKER
        </span>
      </div>
    </Link>
  ...
  return (
    <div className="min-h-screen flex flex-col relative z-10">
      <div className="absolute inset-0 -z-10 h-full w-full bg-white dark:bg-neutral-950 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] dark:bg-[radial-gradient(#1f2937_1px,transparent_1px)] [background-size:20px_20px]">
        <div className="absolute inset-0 bg-gradient-to-tr from-neutral-500/5 via-transparent to-black/5 dark:from-white/5 dark:to-transparent" />
      ...
      <main className="flex-1 flex items-center pt-10 pb-24 lg:pt-20 lg:pb-32 px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full">
          <div className="max-w-2xl text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-100 dark:bg-neutral-900 text-black dark:text-white font-bold text-xs mb-6 border border-neutral-200 dark:border-neutral-800">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black mb-6 leading-[1.05] text-slate-900 dark:text-white uppercase">
            ...
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 mb-10 font-medium leading-relaxed">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-neutral-300/40 to-neutral-400/40 dark:from-neutral-700/40 dark:to-neutral-800/40 rounded-[2.5rem] transform rotate-3 scale-105 blur-lg" />
            ...
            <div className="relative w-[120%] -right-10 bg-white dark:bg-[#0e1116] border border-slate-200 dark:border-slate-800 shadow-2xl rounded-2xl overflow-hidden animate-float">
              ...
              <div className="flex h-[400px]">
                ...
                <div className="flex-1 p-6 bg-white dark:bg-[#0e1116]">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                      ...
                      (valueClass, index) => (
                        <div
                          key={index}
                          className="h-24 bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-700/50 rounded-xl p-4 flex flex-col justify-between"
                        >
                          <div className="h-2 bg-neutral-200 dark:bg-neutral-700 rounded w-1/2" />
                          <div className={`h-6 ${valueClass} rounded w-1/3`} />
                        </div>
                      )
                    )}
                  </div>
                  <div className="space-y-3">
                    {[1, 2].map((item) => (
                      <div key={item} className="h-12 border border-slate-100 dark:border-slate-800 rounded-lg w-full flex items-center px-4">
                        <div className="w-4 h-4 rounded-full bg-slate-200 dark:bg-slate-700 mr-3" />
                        <div className={`h-2 bg-slate-200 dark:bg-slate-700 rounded ${item === 1 ? 'w-1/2' : 'w-2/3'}`} />
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="absolute -bottom-10 -left-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-xl shadow-2xl animate-float-reverse flex items-center gap-4">
              ...
              <div>
                <div className="h-2 bg-slate-200 dark:bg-slate-700 rounded w-20 mb-2" />
                <div className="h-2 bg-black dark:bg-white rounded w-32" />
              </div>
            </div>
          </div>
        </div>
